...
proc zadd*(r: Redis | AsyncRedis, key: string, score: SomeInteger, member: string): Future[RedisInteger] {.multisync, gcsafe.} =
...
proc zremrangebyrank*(r: Redis | AsyncRedis, key: string, start: SomeInteger,
                     stop: SomeInteger): Future[RedisInteger] {.multisync, gcsafe.} =
...
proc zremrangebyscore*(r: Redis | AsyncRedis, key: string, min: SomeInteger,
                      max: SomeInteger): Future[RedisInteger] {.multisync, gcsafe.} =
...
proc zscore*(r: Redis | AsyncRedis, key: string, member: string): Future[RedisInteger] {.multisync, gcsafe.} =
